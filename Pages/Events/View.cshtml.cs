...
namespace KampongTalk.Pages.Events
{
    public class ViewModel : PageModel
    {
        ...
        public static MightyOrm eventDb { get; set; } = new MightyOrm(ConfigurationManager.AppSetting["ConnectionStrings:KampongTalkDbConnection"], "Events", "Eid");
